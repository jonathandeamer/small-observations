...
- **Before going live:** set `baseURL` in `hugo.toml` to the real domain. It is currently `https://example.org/` which will produce wrong URLs in RSS feeds, sitemaps, and Open Graph tags.
